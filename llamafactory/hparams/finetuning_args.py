...
class DistillArguments:
    r"""
    Arguments pertaining to the Distillation.
    """
    use_distill: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the distillation."},
    )
    use_progressive_distill: bool = field(
        default=False,
        metadata={"help": "Whether or not to use progressive distill."},
    )
    distill_alpha: float = field(
        default=0.9,
        metadata={"help": "The balance weight for the distillation loss."},
    )
    distill_t: float = field( # This is currently not supported
        default=1.0,
        metadata={"help": "The temperature for the distillation loss."},
    )
    freq_tokens_path: str = field(
        default=None,
        metadata={"help": "The path for the frequent tokens."},
    )
    num_freq_tokens: int = field(
        default=0,
        metadata={"help": "The number of the frequent tokens."},
    )
    distill_beta: float = field(
        default=1.0,
        metadata={"help": "The balance weight for the frequent tokens."},
    )
    distill_gamma: float = field(
        default=1.0,
        metadata={"help": "The balance weight for the logits of the teachers."},
    )


@dataclass
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument, DistillArguments):
    r"""
